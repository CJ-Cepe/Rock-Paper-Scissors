...
const game = function () {
    ...
    let playerScoreElemennt = document.querySelector('player-score');
    let p1Score = 0;

    let cpuScoreElemennt = document.querySelector('cpu-score');
    let cpuScore = 0;
...
//====================================================
let pokeballOne = document.querySelector('');
let pokeballTwo = document.querySelector('')
let pokeballThree = document.querySelector('');
